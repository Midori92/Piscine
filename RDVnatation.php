...
<main>
 <div id="rightcolumn">
            <h2>Coach de Piscine</h2>
            <div class="coach-details">
                <img src="luciebertrand.jpeg" alt="Coach de Piscine" class="coach-photo" width="175" heigh="150">
                <p><strong>Nom:</strong> Lucie Bertrand</p>
                <p><strong>Bureau:</strong> 01 Piscine Muniscipale, 92100 Boulogne-Billancourt</p>
...
<?php
                ...
                foreach ($heures as $hour) {
                    ...
                    foreach ($days as $day) {
                        ...
                        if (mysqli_num_rows($result_edt) > 0) {
                            ...
                            echo "<form method='post' action='RDVnatation2.php'>";
               ...
               <div class="button-group">
                    <button class="btn-rdv"  id="book-appointment" onclick="window.location.href='RDVnatation.php'">Prendre Rendez-vous</button>
                    <button class="btn-comm" onclick="communicateWithCoach()">Communiquer avec le coach</button>
                    <button class="btn-cv" onclick="window.location.href='CVnatation.html'">Voir le CV </button>
...
function communicateWithCoach() {
    ...
    if (choice === '1') {
        alert("Appeler le coach au numéro: (+33) 6 453221009");
    } else if (choice === '2') {
        window.location.href = "mailto:lucie.bertrand@sportify.com";
    } else if (choice === '3') {
        window.location.href = 'natation.html';
    } else {
