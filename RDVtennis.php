...
<main>
 ...
 <div id="rightcolumn">
            <h2>Coach de Tennis</h2>
            <div class="coach-details">
                <img src="jeandupont.jpeg" alt="Coach Tennis" class="coach-photo" width="150" heigh="150">
                <p><strong>Nom:</strong> Jean Dupont</p>
                <p><strong>Bureau:</strong> 123 rue de la Raquette, 75001 Paris</p>
...
<?php
                ...
                foreach ($heures as $hour) {
                    ...
                    foreach ($days as $day) {
                        ...
                        if (mysqli_num_rows($result_edt) > 0) {
                            ...
                            echo "<form method='post' action='RDVtennis2.php'>";
                ...
                <div class="button-group">
                    <button class="btn-rdv"  id="book-appointment" onclick="window.location.href='RDVtennis.php'">Prendre Rendez-vous</button>
                    <button class="btn-comm" onclick="communicateWithCoach()">Communiquer avec le coach</button>
                    <button class="btn-cv" onclick="window.location.href='CVtennis.html'">Voir le CV </button>
