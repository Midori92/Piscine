...
<main>
 ...
 <div id="rightcolumn">
            <h2>Coach de Cardio-Trainning</h2>
            <div class="coach-details">
                <img src="elisagarnier.jpeg" alt="Coach de Cardio Trainning" class="coach-photo" width="190" heigh="150">
                <p><strong>Nom:</strong> Elisa Garnier</p>
...
<?php
                ...
                foreach ($heures as $hour) {
                    ...
                    foreach ($days as $day) {
                        ...
                        if (mysqli_num_rows($result_edt) > 0) {
                            ...
                            echo "<form method='post' action='RDVcardio2.php'>";
                ...
                <div class="button-group">
                    <button class="btn-rdv"  id="book-appointment" onclick="window.location.href='RDVcardio.php'">Prendre Rendez-vous</button>
                    <button class="btn-comm" onclick="communicateWithCoach()">Communiquer avec le coach</button>
                    <button class="btn-cv" onclick="window.location.href='CVcardio.html'">Voir le CV </button>
...
function communicateWithCoach() {
    ...
    if (choice === '1') {
        alert("Appeler le coach au numéro: (+33) 643210987");
    } else if (choice === '2') {
        window.location.href = "mailto:elisa.garnier@sportify.com";
    } else if (choice === '3') {
