...
<main>
 <div id="rightcolumn">
            ...
            <div class="coach-details">
                <img src="guydumais.jpeg" alt="Coach de Boxe" class="coach-photo" width="200" heigh="150">
                <p><strong>Nom:</strong> Guy Dumais </p>
...
<?php
                ...
                foreach ($heures as $hour) {
                    ...
                    foreach ($days as $day) {
                        ...
                        if (mysqli_num_rows($result_edt) > 0) {
                            ...
                            echo "<form method='post' action='RDVboxe2.php'>";
                ...
                <div class="button-group">
                    <button class="btn-rdv"  id="book-appointment" onclick="window.location.href='disponibilites.html'">Prendre Rendez-vous</button>
                    <button class="btn-comm" onclick="communicateWithCoach()">Communiquer avec le coach</button>
                    <button class="btn-cv" onclick="window.location.href='CVboxe.html'">Voir le CV </button>
...
function communicateWithCoach() {
    ...
    if (choice === '1') {
        alert("Appeler le coach au numéro: (+33) 2 147483");
    } else if (choice === '2') {
        window.location.href = "mailto:guy.dumais@sportify.com";
    } else if (choice === '3') {
        window.location.href = 'boxe.html';
    } else {
