...
<main>
 <div id="rightcolumn">
            <h2>Porfesseur de Danse</h2>
            <div class="coach-details">
                <img src="clarapetit.jpeg" alt="Professeur de Danse" class="coach-photo" width="200" heigh="150">
                <p><strong>Nom:</strong> Clara Petit</p>
                <p><strong>Bureau:</strong> 77 rue de la Danse, 75009 Paris</p>
...
<?php
                ...
                foreach ($heures as $hour) {
                    ...
                    foreach ($days as $day) {
                        ...
                        if (mysqli_num_rows($result_edt) > 0) {
                            ...
                            echo "<form method='post' action='RDVdanse2.php'>";
                ...
                <div class="button-group">
                    <button class="btn-rdv"  id="book-appointment" onclick="window.location.href='RDVdanse.php'">Prendre Rendez-vous</button>
                    <button class="btn-comm" onclick="communicateWithCoach()">Communiquer avec le coach</button>
                    <button class="btn-cv" onclick="window.location.href='CVdanse.html'">Voir le CV </button>
...
function communicateWithCoach() {
    ...
    if (choice === '1') {
        alert("Appeler le coach au numéro: (+33) 01 02 03 04 05 06");
    } else if (choice === '2') {
        window.location.href = "mailto:jean.dupont@sportify.com";
    } else if (choice === '3') {
        window.location.href = 'danse.html';
    } else {
