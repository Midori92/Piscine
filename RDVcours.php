...
<main>
 ...
 <div id="rightcolumn">
            <h2>Coach de Cours Collectifs</h2>
            <div class="coach-details">
                <img src="marcleclerc.jpeg" alt="Coach Cours" class="coach-photo" width="150" heigh="150">
                <p><strong>Nom:</strong> Marc Leclerc</p>
...
<?php
                ...
                foreach ($heures as $hour) {
                    ...
                    foreach ($days as $day) {
                        ...
                        if (mysqli_num_rows($result_edt) > 0) {
                            ...
                            echo "<form method='post' action='RDVcours2.php'>";
                ...
                <div class="button-group">
                    <button class="btn-rdv"  id="book-appointment" onclick="window.location.href='RDVcours.php'">Prendre Rendez-vous</button>
                    <button class="btn-comm" onclick="communicateWithCoach()">Communiquer avec le coach</button>
                    <button class="btn-cv" onclick="window.location.href='CVcours.html'">Voir le CV </button>
...
function communicateWithCoach() {
    ...
    if (choice === '1') {
        alert("Appeler le coach au numéro: (+33) 621098765");
    } else if (choice === '2') {
        window.location.href = "mailto:marc.leclerc@sportify.com";
    } else if (choice === '3') {
