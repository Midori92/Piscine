...
<main>
 <div id="rightcolumn">
            <h2>Coach de Football</h2>
            <div class="coach-details">
                <img src="paulmartin.jpeg" alt="Coach de Football" class="coach-photo" width="150" heigh="150">
                <p><strong>Nom:</strong> Paul Martin</p>
                <p><strong>Bureau:</strong> 88 Boulevard du But, 75015 Paris</p>
...
<?php
                ...
                foreach ($heures as $hour) {
                    ...
                    foreach ($days as $day) {
                        ...
                        if (mysqli_num_rows($result_edt) > 0) {
                            ...
                            echo "<form method='post' action='RDVfoot2.php'>";
                ...
                <div class="button-group">
                    <button class="btn-rdv"  id="book-appointment" onclick="window.location.href='RDVfoot.php'">Prendre Rendez-vous</button>
                    <button class="btn-comm" onclick="communicateWithCoach()">Communiquer avec le coach</button>
                    <button class="btn-cv" onclick="window.location.href='CVfoot.html'">Voir le CV </button>
...
function communicateWithCoach() {
    ...
    if (choice === '1') {
        alert("Appeler le coach au numéro: (+33) 6 87654321");
    } else if (choice === '2') {
        window.location.href = "mailto:paul.martin@sportify.com";
    } else if (choice === '3') {
