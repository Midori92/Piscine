...
<main>
 <div id="rightcolumn">
            <h2>Professeur de Musculation</h2>
            <div class="coach-details">
                <img src="kevinmoreau.jpeg" alt="Coach de Muscu" class="coach-photo" width="200" heigh="150">
                <p><strong>Nom:</strong> Kevin Moreau </p>
...
<?php
                ...
                foreach ($heures as $hour) {
                    ...
                    foreach ($days as $day) {
                        ...
                        if (mysqli_num_rows($result_edt) > 0) {
                            ...
                            echo "<form method='post' action='RDVmuscu2.php'>";
                ...
                <div class="button-group">
                    <button class="btn-rdv"  id="book-appointment" onclick="window.location.href='RDVmuscu.php'">Prendre Rendez-vous</button>
                    <button class="btn-comm" onclick="communicateWithCoach()">Communiquer avec le coach</button>
                    <button class="btn-cv" onclick="window.location.href='CVmuscu.html'">Voir le CV </button>
...
function communicateWithCoach() {
    ...
    if (choice === '1') {
        alert("Appeler le coach au numéro: (+33) 6 65432109");
    } else if (choice === '2') {
        window.location.href = "mailto:kevin.moreau@sportify.com";
    } else if (choice === '3') {
        window.location.href = 'musculation.html';
    } else {
