...
<main>
 <div id="rightcolumn">
            <h2>Coach de Basketball</h2>
            <div class="coach-details">
                <img src="marinedubois.jpeg" alt="Coach Basket" class="coach-photo" width="150" heigh="150">
                <p><strong>Nom:</strong> Marine Dubois</p>
                <p><strong>Bureau:</strong> 45 avenue du Dribble, 75012 Paris</p>
...
<?php
                ...
                foreach ($heures as $hour) {
                    ...
                    foreach ($days as $day) {
                        ...
                        if (mysqli_num_rows($result_edt) > 0) {
                            ...
                            echo "<form method='post' action='RDVbasket2.php'>";
               ...
               <div class="button-group">
                    <button class="btn-rdv"  id="book-appointment" onclick="window.location.href='RDVbasket.'">Prendre Rendez-vous</button>
                    <button class="btn-comm" onclick="communicateWithCoach()">Communiquer avec le coach</button>
                    <button class="btn-cv" onclick="window.location.href='CVbasket.'">Voir le CV </button>
