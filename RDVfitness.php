...
<main>
 ...
 <div id="rightcolumn">
            <h2>Coach de Fitness</h2>
            <div class="coach-details">
                <img src="sophieleroy.jpeg" alt="Coach Fitness" class="coach-photo" width="150" heigh="150">
                <p><strong>Nom:</strong> Sophie Leroy</p>
...
<?php
                ...
                foreach ($heures as $hour) {
                    ...
                    foreach ($days as $day) {
                        ...
                        if (mysqli_num_rows($result_edt) > 0) {
                            ...
                            echo "<form method='post' action='RDVfitness2.php'>";
                ...
                <div class="button-group">
                    <button class="btn-rdv"  id="book-appointment" onclick="window.location.href='RDVfitness.php'">Prendre Rendez-vous</button>
                    <button class="btn-comm" onclick="communicateWithCoach()">Communiquer avec le coach</button>
                    <button class="btn-cv" onclick="window.location.href='CVfitness.html'">Voir le CV </button>
...
function communicateWithCoach() {
    ...
    if (choice === '1') {
        alert("Appeler le coach au numéro: (+33) 654321098");
    } else if (choice === '2') {
        window.location.href = "mailto:sophie.leroy@sportify.com";
    } else if (choice === '3') {
